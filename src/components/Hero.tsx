      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-6 lg:grid-cols-2 lg:gap-16 lg:px-8">
        ...
        >
          ...
          <p className="max-w-lg text-base leading-relaxed text-muted sm:text-lg">
            From concept to launch, we craft modern digital experiences that
            help businesses grow, engage users, and stand out in a competitive
            market.
          </p>
        </motion.div>
        ...
        >
          <div className="relative h-[420px] w-full max-w-md sm:h-[480px]">
            <div className="absolute top-1/2 left-1/2 h-[340px] w-[340px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-gold/40" />
