  ...
  return (
    <section id="about" className="px-6 py-8 lg:px-8">
      <motion.div
        ...
        className="mx-auto flex max-w-7xl flex-col items-center gap-6 rounded-2xl border border-card-border bg-card px-6 py-6 sm:flex-row sm:gap-8 sm:px-8"
      >
        ...
        <p className="flex-1 text-center text-sm leading-relaxed text-muted sm:text-left sm:text-base">
          I&apos;m a digital product strategist and designer helping businesses
